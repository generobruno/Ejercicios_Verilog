...
#
# Script generated by Vivado on Wed Mar 20 16:30:45 -03 2024
...
# script info
echo -e "clk_wiz.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bruno/Documents/Facultad/5to_anio/Arquitectura_de_Computadoras/Ejercicios_Verilog/PIPELINE_Test/PIPELINE_Test.cache/compile_simlib/modelsim"
  fi
